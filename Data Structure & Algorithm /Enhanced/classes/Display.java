...
/**
 * The Display class is a common class between the four principal classes
 * of the monitoring system program. This class control the content and 
 * presentation of each screen and dashboard in the program.
 *
 */
    ...
    public static boolean showMenu(String userRole, String user, String path) throws Exception {
        ...
        while (!exit) {
            ...
            switch (option) {
                case 'h':
                    monitor = "habitats";
                    exit = MonitorModule.showDashboard(userRole, user, path, monitor);
                    break;
                case 'a':
                    monitor = "animals";
                    exit = MonitorModule.showDashboard(userRole, user, path, monitor);
                    break;
                case 'u':
                    UsersModule.showMngrTable(userRole, user, path);
                    break;
                case 'z':
                    clearScreen();
