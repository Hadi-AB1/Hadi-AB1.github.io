...
/**
 * This is second of the four principal classes of the monitoring system
 * program, RoleModule. This class read the specific user role text file
 * and display the content in the Main Dashboard screen with the decription
 * of the user job and their menu options to use in the system.
 *
 */
